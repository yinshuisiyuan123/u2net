...
from my_datset_voc import VOCSegmentation
#import transforms as T
import transformsvoc as T
...
def main(args):
    ...
    train_dataset = VOCSegmentation(args.data_path, year="2007", transforms=get_transform(train=True), txt_name="train.txt")
    val_dataset = VOCSegmentation(args.data_path, year="2007", transforms=get_transform(train=False), txt_name="val.txt")
...
def parse_args():
    ...
    parser.add_argument("--data-path", default=r"D:\detection\crack", help="VOCdevkit root")
